...
import { 
  ...
  Copyright, Send, Instagram, ExternalLink
} from 'lucide-react';
...
const PROJECTS = [
  {
    ...
    live: "https://youtu.be/65DihMGc9KM?si=7zZzq8HD-wdt5Vwb",
  ...
  },
  {
    ...
    github: "https://github.com/SatyabrataPanda42/HireReady",
    live: "https://hireready-two.vercel.app/signin", 
  ...
  },
  {
    ...
    github: "https://github.com/SatyabrataPanda42/FinTrack",
    live: "https://fin-track-sweettoothplays-projects.vercel.app/", 
...
export default function App() {
  ...
  // Initial Sync - Force Dark Mode on mount and keep it
  useEffect(() => {
    setMounted(true);
  ...
  return (
    <div className="min-h-screen bg-[#0b0b0f] text-slate-100 transition-colors duration-500 font-sans selection:bg-blue-500/30 overflow-x-hidden text-[15px]">
      
      {/* NAVBAR */}
      <nav className="fixed top-0 w-full z-[100] backdrop-blur-md bg-black/40 border-b border-white/10">
      ...
      {/* HERO SECTION */}
      <section className="min-h-[95vh] flex items-center px-4 md:px-6 max-w-7xl mx-auto pt-24 pb-8">
        <div className="flex flex-col md:grid md:grid-cols-[1.35fr_0.65fr] gap-10 md:gap-12 items-center w-full">
          ...
          <div className="order-2 md:order-1 space-y-6 z-20 text-center md:text-left">
            ...
            <p className="text-base md:text-lg text-slate-400 max-w-lg mx-auto md:mx-0 leading-relaxed font-medium">
            ...
            <div className="flex flex-wrap justify-center md:justify-start gap-4 pt-2">
              ...
              <div className="flex items-center gap-3">
                <a href="https://github.com/SatyabrataPanda42" target="_blank" rel="noopener noreferrer" className="p-3.5 rounded-2xl bg-white/5 hover:bg-blue-600 hover:text-white transition-all border border-white/5"><Github size={20}/></a>
                <a href="https://www.linkedin.com/in/satyabrata-panda-182975264/" target="_blank" rel="noopener noreferrer" className="p-3.5 rounded-2xl bg-white/5 hover:bg-blue-600 hover:text-white transition-all border border-white/5"><Linkedin size={20}/></a>
                <a href="https://www.instagram.com/satyabratapanda._?igsh=MTFrbjRzNXE1OWpo" target="_blank" rel="noopener noreferrer" className="p-3.5 rounded-2xl bg-white/5 hover:bg-blue-600 hover:text-white transition-all border border-white/5"><Instagram size={20}/></a>
              </div>
            </div>
          </div>
          ...
          <div className="order-1 md:order-2 relative flex justify-center z-10 w-full md:w-auto">
            ...
            <div className="relative w-56 h-56 sm:w-72 sm:h-72 md:w-[380px] md:h-[480px] lg:w-[420px] lg:h-[520px] overflow-hidden rounded-[2.5rem] md:rounded-[3.5rem] md:ml-24 lg:ml-32 hover:scale-[1.02] transition-all duration-700 shadow-2xl border-4 border-white/10 group">
              <img 
      ...
      <Reveal>
        <section id="skills" className="py-12 px-4 md:px-6 max-w-7xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-black mb-10 tracking-tighter uppercase text-center md:text-left">Technical Arsenal</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            {SKILL_GROUPS.map((group, i) => (
              <div key={i} className="group bg-[#0f0f14] rounded-[2.5rem] p-8 border border-white/5 hover:border-blue-500/30 shadow-sm hover:shadow-[0_20px_50px_rgba(37,99,235,0.1)] transition-all duration-500 flex flex-col hover:-translate-y-2 relative overflow-hidden">
                ...
                <h3 className="text-xl font-black mb-8 text-white group-hover:text-blue-600 uppercase tracking-tighter flex items-center gap-2 transition-colors duration-300">
                ...
                <div className="flex flex-wrap gap-2 md:gap-3">
                  {group.skills.map((skill, j) => (
                    <span 
                      key={j} 
                      className={`px-3 py-1.5 md:px-4 md:py-2 bg-white/10 rounded-xl text-[10px] md:text-xs font-bold border border-white/5 text-white hover:scale-110 hover:text-blue-400 hover:border-blue-600 hover:shadow-[0_0_25px_-5px] ${group.glow} transition-all cursor-default shadow-sm`}
                    >
                      {skill}
                    </span>
                  ))}
      ...
      <Reveal>
        <section id="projects" className="py-12 px-4 md:px-6 max-w-7xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-black mb-10 tracking-tighter uppercase text-center md:text-left">Selected Works</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            {PROJECTS.map((p, i) => (
              <div key={i} className="group bg-[#0f0f14] rounded-[2.5rem] p-8 border border-white/5 hover:border-blue-500/30 shadow-sm hover:shadow-[0_20px_50px_rgba(37,99,235,0.1)] transition-all duration-500 flex flex-col justify-between hover:-translate-y-2 relative overflow-hidden">
                <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-blue-600 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
                <div>
                  <div className="flex justify-between items-start mb-8">
                    <div className="w-14 h-14 rounded-[1.25rem] bg-white/5 flex items-center justify-center group-hover:bg-blue-600 group-hover:text-white transition-all duration-500 group-hover:rotate-[10deg]">
                      <Zap size={28} />
                    </div>
                    <div className="flex gap-2">
                      {p.github && (
                        <a href={p.github} target="_blank" rel="noopener noreferrer" className="p-2.5 rounded-xl bg-white/5 hover:text-blue-600 transition-colors border border-white/10 shadow-sm">
                          <Github size={18} />
                        </a>
                      )}
                      <a href={p.live} target="_blank" rel="noopener noreferrer" className="p-2.5 rounded-xl bg-white/5 hover:text-blue-600 transition-colors border border-white/10 shadow-sm">
                  ...
                  <p className="text-slate-400 mb-8 text-sm font-medium leading-relaxed">{p.desc}</p>
                  <div className="flex flex-wrap gap-2 mb-8">
                    {p.tech.map((t, idx) => (
                      <span key={idx} className="text-[10px] font-black uppercase tracking-widest text-blue-400 bg-blue-500/5 border border-blue-500/10 px-2.5 py-1 rounded-lg">
                        {t}
                      </span>
                    ))}
                  </div>
                ...
                <button 
                  ...
                  className="w-full bg-white/5 border border-white/10 py-4 rounded-[1.25rem] font-black text-[10px] uppercase tracking-widest hover:bg-blue-600 hover:text-white transition-all shadow-sm active:scale-95 group-hover:shadow-lg"
                >
                  Explore Analysis
                </button>
              </div>
      ...
      <Reveal>
        <section id="education" className="py-12 px-4 md:px-6 max-w-7xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-black mb-12 tracking-tighter uppercase flex items-center gap-4 text-center md:text-left">
            <GraduationCap className="text-blue-600" /> Academic Foundation
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
             <div className="group bg-[#0f0f14] p-8 md:p-10 rounded-[2.5rem] md:rounded-[3rem] border border-white/5 hover:border-blue-500/30 transition-all duration-500 flex flex-col justify-between hover:-translate-y-2 shadow-sm hover:shadow-[0_20px_50px_rgba(37,99,235,0.1)] relative overflow-hidden">
                <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-blue-600 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
             ...
             <div className="group bg-[#0f0f14] p-8 md:p-10 rounded-[2.5rem] md:rounded-[3rem] border border-white/5 hover:border-blue-500/30 transition-all duration-500 flex flex-col justify-between hover:-translate-y-2 shadow-sm hover:shadow-[0_20px_50px_rgba(37,99,235,0.1)] relative overflow-hidden">
                ...
                <div className="mt-8 pt-8 border-t border-white/10 flex flex-col items-center justify-center text-center">
                   ...
                   <p className="text-4xl font-black tracking-tighter text-blue-600">67 <span className="text-sm opacity-60 text-white font-black">%</span></p>
                </div>
             </div>
          </div>
        </section>
      ...
      <Reveal>
        <section id="contact" className="py-12 px-4 md:px-6 max-w-7xl mx-auto">
          <div className="group bg-[#0f0f14] p-8 md:p-12 rounded-[3rem] border border-white/5 hover:border-blue-500/30 transition-all duration-500 hover:-translate-y-1 shadow-sm hover:shadow-[0_20px_50px_rgba(37,99,235,0.05)] relative overflow-hidden">
            <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-blue-600 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
            <div className="flex flex-col md:flex-row items-center justify-between gap-8 text-center md:text-left">
              <div>
                <h2 className="text-2xl md:text-3xl font-black tracking-tighter uppercase mb-2">Let's Connect</h2>
                <p className="text-slate-400 font-medium">Have a project in mind or just want to say hi?</p>
              </div>
              <div className="flex flex-col items-center md:items-end gap-3">
                ...
                <a 
                  ...
                  className="text-xl md:text-2xl font-black tracking-tight text-white hover:text-blue-600 transition-colors flex items-center gap-3 group/mail break-all"
                >
      ...
      <footer className="py-12 border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 md:px-6 flex flex-col md:flex-row justify-between items-center gap-12 text-center md:text-left">
          ...
          <div className="flex gap-4">
            <a href="mailto:satyabratapandaaims@gmail.com" target="_blank" rel="noopener noreferrer" className="p-4 rounded-2xl bg-white/5 hover:bg-blue-600 hover:text-white transition-all border border-white/5 shadow-sm"><Mail size={22}/></a>
            <a href="https://www.linkedin.com/in/satyabrata-panda-182975264/" target="_blank" rel="noopener noreferrer" className="p-4 rounded-2xl bg-white/5 hover:bg-blue-600 hover:text-white transition-all border border-white/5 shadow-sm"><Linkedin size={22}/></a>
            <a href="https://github.com/SatyabrataPanda42" target="_blank" rel="noopener noreferrer" className="p-4 rounded-2xl bg-white/5 hover:bg-blue-600 hover:text-white transition-all border border-white/5 shadow-sm"><Github size={22}/></a>
            <a href="https://www.instagram.com/satyabratapanda._?igsh=MTFrbjRzNXE1OWpo" target="_blank" rel="noopener noreferrer" className="p-4 rounded-2xl bg-white/5 hover:bg-blue-600 hover:text-white transition-all border border-white/5 shadow-sm"><Instagram size={22}/></a>
          </div>
        </div>
      </footer>
      ...
      {selectedProject && (
        <div className="fixed inset-0 z-[150] flex items-center justify-center p-4 md:p-6 bg-black/95 backdrop-blur-md animate-in fade-in">
          <div className="bg-[#15151a] w-full max-w-2xl rounded-[2.5rem] md:rounded-[3.5rem] overflow-hidden shadow-2xl relative border border-white/10 max-h-[90vh] overflow-y-auto">
            <button onClick={() => setSelectedProject(null)} className="absolute top-6 right-6 md:top-10 md:right-10 p-2 md:p-3 bg-white/10 rounded-full hover:bg-red-500 hover:text-white transition-all active:scale-95 z-20"><X size={20}/></button>
            <div className="p-8 md:p-16">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                <h3 className="text-3xl md:text-4xl font-black tracking-tighter uppercase leading-tight">{selectedProject.title}</h3>
                <div className="flex gap-2">
                  {selectedProject.github && (
                    <a href={selectedProject.github} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-4 py-2 bg-white/10 rounded-xl text-[10px] font-black uppercase hover:bg-blue-600 hover:text-white transition-all">
                      Code <Github size={14} />
                    </a>
                  )}
                  <a href={selectedProject.live} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-4 py-2 bg-white/10 rounded-xl text-[10px] font-black uppercase hover:bg-blue-600 hover:text-white transition-all">
              ...
              <div className="space-y-8">
                <p className="text-slate-400 text-base md:text-lg leading-relaxed font-medium">{selectedProject.longDesc}</p>
                <div className="bg-white/5 p-6 md:p-8 rounded-3xl border border-white/10 font-medium">
                  <h4 className="font-black mb-6 text-[10px] uppercase tracking-widest text-blue-600 flex items-center gap-2"><Zap size={14}/> Impact & Performance</h4>
